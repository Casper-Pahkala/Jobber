...
public class MyWorkPlaceAdapter2 extends RecyclerView.Adapter<MyWorkPlaceAdapter2.MyViewHolder> {
    ...
    public static WorkerAdapter adapter;

    public MyWorkPlaceAdapter2(Context context, ArrayList<WorkPlaceModel> list, Activity activity, int workerCount) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        adapter=new WorkerAdapter(context,workerModelList,activity);
