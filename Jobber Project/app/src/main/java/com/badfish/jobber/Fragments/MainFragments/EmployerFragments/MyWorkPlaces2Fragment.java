...
import com.badfish.jobber.Adapters.MyWorkPlaceAdapter2;
...
public class MyWorkPlaces2Fragment extends Fragment {

    TextView applyButton;
    ArrayList<WorkPlaceModel> workPlaceList;
    MyWorkPlaceAdapter2 adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MyWorkPlaceAdapter2(getContext(), workPlaceList, getActivity(), workerCount);
    ...
    public MyWorkPlaces2Fragment() {
        // Required empty public constructor
    }
    public static MyWorkPlaces2Fragment newInstance(String param1, String param2) {
        MyWorkPlaces2Fragment fragment = new MyWorkPlaces2Fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_work_places2, container, false);
    }
}