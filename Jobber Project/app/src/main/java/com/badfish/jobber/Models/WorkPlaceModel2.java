...
public class WorkPlaceModel2 {
    ...
    String distance, jobDescription,jobToken,employerName,id,workerAddress, employerUID,jobAddress, date, time,workerToken,workerUserID,workerName, employerProfilePicture
            ,workerProfilePicture, lastText;
    Long lastTextTime;



    public WorkPlaceModel2(String distance, String employerName, String jobDescription, String id, String workerAddress, String workerUserID, String workerToken
            , String employerUID, String jobAddress
    , String jobToken, String date, String time, String workerName, String employerProfilePicture, String workerProfilePicture, String lastText, Long lastTextTime) {
